                                                            ...
                                                            <c:forEach var="sv" items="${requestScope.SERVICE}" varStatus="counter">
                                                                <c:forEach var="dto" items="${requestScope.R_PRICE}">
                                                                    <form action="MainController" method="POST">
                                                                        <div class="card">
                                                                            <div class="card-body">
                                                                                <p class="fs-5">Bill summary</p>
                                                                                <div class="my-3 border-top"></div>
                                                                                <div class="d-flex align-items-center">
                                                                                    <a class="d-block flex-shrink-0" href="javascript:;">
                                                                                        <img src="#" width="75" alt="Electric">
                                                                                    </a>
                                                                                    <div class="ps-2">
                                                                                        <h6 class="mb-1">Electronic Price</h6>
                                                                                        <div class="widget-product-meta"><span class="me-2">$0.1</span><span class="">x ${requestScope.Electronic} = ${sv.electronicPrice}$</span>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="my-3 border-top"></div>
                                                                                <div class="d-flex align-items-center">
                                                                                    <a class="d-block flex-shrink-0" href="javascript:;">
                                                                                        <img src="#" width="75" alt="Water">
                                                                                    </a>
                                                                                    <div class="ps-2">
                                                                                        <h6 class="mb-1">Water Price</h6>
                                                                                        <div class="widget-product-meta"><span class="me-2">$0.4</span><span class="">x ${requestScope.Water} = ${sv.waterPrice}$</span>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>  
                                                                                ...
                                                                                <div class="d-flex align-items-center">
                                                                                    <a class="d-block flex-shrink-0" href="javascript:;">
                                                                                        <img src="#" width="75" alt="Room">
                                                                                    </a>
                                                                                    <div class="ps-2">
                                                                                        <h6 class="mb-1">Room Price</h6>
                                                                                        <div class="widget-product-meta"><span class="me-2">${dto.roomPrice}$</span><span class=""></span>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
