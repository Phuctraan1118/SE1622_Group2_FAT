<%-- 
    Document   : page-edit-profile-user-google
    Created on : Jun 21, 2022, 8:34:36 PM
    Author     : buikh
--%>
                                        ...
                                        <form action="MainController" method="post">
                                            ...
                                            <div class="mb-4 d-flex flex-column gap-3 align-items-center justify-content-center">
                                                <div class="user-change-photo shadow">
                                                    ...
                                                    <input type="hidden" name="txtPassword" value="${USER.password}" class="form-control" value="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="text-start mt-3">
                                                <input type="submit" value="Save" name="btn" class="btn btn-primary px-4"/>
                                            </div>
                                        </form>
                                    </c:if>
                                </div>
