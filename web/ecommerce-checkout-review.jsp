                                  ...
                                  <div class="col-12 col-lg-3">
                                    <div class="text-center">
                                      <div class="d-flex gap-2 justify-content-center justify-content-lg-end"> 
                                        <a href="javascript:;" class="btn btn-light btn-ecomm"><i class='bx bx-x-circle mx-0'></i></a>
                                        <a href="javascript:;" class="btn btn-primary btn-ecomm"><i class='bx bx-edit'></i>Edit</a>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div class="card-body">
                                <div class="row align-items-center g-2">
                                  <div class="col-12 col-lg-6">
                                    <div class="d-lg-flex align-items-center gap-2">
                                      <div class="cart-img text-center text-lg-start">
                                        <img src="assets/images/products/10.png" width="130" alt="">
                                      </div>
                                      <div class="cart-detail text-center text-lg-start">
                                        <h6 class="mb-2">Headphone Orange</h6>
                                        <p class="mb-0">Size: <span>Medium</span>
                                        </p>
                                        <p class="mb-2">Color: <span>Orange</span>
                                        </p>
                                        <h5 class="mb-0">$14.00</h5>
                                      </div>
                                    </div>
                                ...
                                <div class="row">
                                  <div class="col-md-6">
                                    <div class="shipping-aadress">
                                      ...
                                      <p class="mb-1"><span>Customer:</span> <span class="h6">Jhon Michle</span></p>
                                      <p class="mb-1"><span>Address:</span> <span class="h6">47-A, Street Name, City, Australia</span></p>
                                      <p class="mb-1"><span>Phone:</span> <span class="h6">(123) 472-796</span></p>
                                    </div>
                                  </div>
                                  <div class="col-md-6">
                          ...
                          <div class="card">
                            ...
                            <div class="card mb-0">
                              <div class="card-body">
                                ...
                                <p class="mb-2">Deposit: <span class="float-end">--</span>
                                </p>
