                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <div class="d-flex align-items-center mb-3">
                                                                <div class="">
                                                                    <img src="${User.img}" width="80" alt="" class="rounded-circle p-1 shadow-sm">
                                                                </div>
                                                                <div class="ms-3">
                                                            ...
                                                            <div class="">
                                                                ...
                                                                <div class="form-body">
                                                                    <form class="MainController">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="d-grid">
                                                                                <a href="ecommerce-checkout-deposit-user.jsp" class="btn btn-primary btn-ecomm">Proceed to Checkout<i class='bx bx-chevron-right'></i></a>
                                                                            </div>
                                                                        </div>
                                                                    </form>
                                                                </div>
