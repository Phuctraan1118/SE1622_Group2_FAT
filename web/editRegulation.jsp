                                                ...
                                                <div class="p-4 border rounded">
                                                    <form class="row g-3" action="MainController" method="POST">
                                                        <div class="row align-content-center">
                                                            <div class="col-md-3">
                                                               <h6> Regulation ID </h6>
                                                                <input type="hidden" class="form-control" id="validationDefault01" name="reguId" value="${param.reguId}" required="">
                                                                </br> ${param.reguId}
                                                            </div>
                                                            <div class="col-md-3">
                                                               <h6> Regulation Name </h6>
                                                               <input type="text" class="form-control" id="validationDefault02" name="reguName" value="${param.reguName}" required="">
                                                            </div>
                                                            <div class="col-md-2">
                                                                <h6> Regulation Detail </h6>
                                                                <input type="text" class="form-control" id="validationDefault02" name="reguDetail" value="${param.reguDetail}" required="">
                                                            </div>
                                                            <div class="col-md-1">
                                                                <button type="submit" class="btn btn-primary" style="margin-top: 24px;"  name="btn" value="Update Regulation">Update Regulation</button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
