											...
											<div class="card-body">
												<ul class="nav nav-pills mb-3" role="tablist">
													<li class="nav-item" role="presentation">
														<a class="nav-link active" data-bs-toggle="pill" href="#credit-card" role="tab" aria-selected="true">
															<div class="d-flex align-items-center">
													...
													<li class="nav-item" role="presentation">
														<a class="nav-link" data-bs-toggle="pill" href="#paypal-payment" role="tab" aria-selected="false">
															<div class="d-flex align-items-center">
													...
													<li class="nav-item" role="presentation">
														<a class="nav-link" data-bs-toggle="pill" href="#net-banking" role="tab" aria-selected="false">
															<div class="d-flex align-items-center">
												...
												<div class="tab-content" id="pills-tabContent">
															...
															<form>
																...
																<div class="mb-3">
																	...
																	<div class="input-group payment-img">
																		<input type="text" class="form-control" placeholder="Valid Owner number">	<span class="input-group-text rounded-0"><img src="assets/images/icons/mastercard.png" width="35" alt=""></span>
																...
																<div class="row">
																	<div class="col-md-12">
																		<div class="d-grid"><a href="javascript:;" class="btn btn-primary btn-ecomm">Confirm Payment</a>
																		</div>
																	</div>
																</div>
															</form>
													...
													<div class="tab-pane fade" id="paypal-payment" role="tabpanel">
														<div class="p-3 border rounded">
															...
															<div class="mb-3">
																<div class="d-block">	<a href="javscript:;" class="btn btn-light"><i class='bx bxl-paypal'></i>Login to my Paypal</a>
																</div>
															</div>
															<div class="mb-3">
