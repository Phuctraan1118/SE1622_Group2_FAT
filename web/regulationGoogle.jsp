<%-- 
    Document   : regulationGoogle
    Created on : Jul 11, 2022, 8:05:00 PM
    Author     : Bitano
--%>
...
<!--                    <form class="searchbar" action="MainController" method="POST">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h6 class="mb-0 text-uppercase">Regulation</h6>
                    <hr>
                    <div class="card">
                        <div class="card-body">
                            <c:if test = "${not empty sessionScope.LIST_REGULATION_GOOGLE}">
                                <table class="table mb-0 table-hover">
                                    ...
                                    <tbody>
                                        <c:forEach var="regulation" items="${sessionScope.LIST_REGULATION_GOOGLE}" varStatus="counter">
