 ...
 * @author Bitano
 */
@WebServlet(name = "RegulationDisplayGoogleController", urlPatterns = {"/RegulationDisplayGoogleController"})
public class RegulationDisplayGoogleController extends HttpServlet {

     private static final String ERROR = "regulationGoogle.jsp";
    private static final String SUCCESS = "regulationGoogle.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       String url = ERROR;
        ...
        if (!regulationDtos.isEmpty()) {
            session.setAttribute("LIST_REGULATION_GOOGLE", regulationDtos);
        }
        url = SUCCESS;
