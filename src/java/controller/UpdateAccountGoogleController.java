 ...
 * @author buikh
 */
@WebServlet(name = "UpdateAccountGoogleController", urlPatterns = {"/UpdateAccountGoogleController"})
public class UpdateAccountGoogleController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = siteMaps.getProperty(MyApplicationConstants.UpdateAccountFeatures.ERROR_GOOGLE_PAGE);
