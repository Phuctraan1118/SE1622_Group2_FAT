        ...
        <div class="wrapper">
            ...
            <aside class="sidebar-wrapper" data-simplebar="true">
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a href="pages-staff-profile.html">
                            <div class="parent-icon">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="product-info">
                                                            <h6 class="product-name mb-1"><input type="text" name="txtUsername" required="" value="${user.username}"></h6>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="box-input">
                                                        <input type="text" name="txtFullName" required="" value="${user.fullName}">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="box-input">
                                                        <input type="text" name="txtAddress" required="" value="${user.address}">
                                                    </div>
                                                </td>
                    ...
                    <button onclick="showOrHideDiv()">Add Staff</button>
                </div>
                <!-- end page content-->
                <div id="showOrHide">
                    <div class="card radius-10 w-100">
                            ...
                            <div class="table-responsive mt-2">
                                <table class="table align-middle mb-0">
                                    ...
                                    <form action="MainController" method="POST"> 
                                        <tr>
                                            <td><input type="text" name="txtUsername" value="" placeholder="Enter user name" class="box"required=""></td>
                                            <td> ${requestScope.USER_ERROR.usernameError}</td>       
                                            <td><input type="password" name="txtPassword" value="" placeholder="Enter staff password" class="box"required=""></td>
                                            <td> ${requestScope.USER_ERROR.passwordError}</td>   
                                            <td><input type="text" name="txtFullName" value="" placeholder="Enter full name" class="box"required=""></td>
                                            <td> ${requestScope.USER_ERROR.fullNameError}</td>   
                                            <td><input type="text" name="txtEmail" value="" placeholder="Enter staff email" class="box"required=""></td>
                                            <td> ${requestScope.USER_ERROR.emailError}</td>   
                                            <td><input type="text" name="txtAddress" value="" placeholder="Enter staff address" class="box"required=""></td>
                                            <td> ${requestScope.USER_ERROR.addressError}</td>   
                                            <td><input type="text" name="txtPhone" value="" placeholder="Enter staff phone" class="box"required=""></td>
                                            <td> ${requestScope.USER_ERROR.phoneNumError}</td>   
                                            <td><input type="text" name="txtCitizenIdentification" value="" placeholder="Enter citizen identification"required="" class="box"></td>
                                            <td> ${requestScope.USER_ERROR.citizenIndentification}</td>   
                                            <td><input type="file" name="txtImg"></td>
                                            <td>
                                                <div class="d-flex align-items-center gap-3 fs-6">
                                                    <button type="submit" name="btn" value="Add Staff" class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                            title="" data-bs-original-title="Add" class="btn"><ion-icon name="arrow-forward-circle-sharp"></ion-icon></button>
                                                </div>        
                                            </td>
