 ...
 * @author Bitano
 */
@WebServlet(name = "UpdateBookedRoomController", urlPatterns = {"/UpdateBookedRoomController"})
public class UpdateBookedRoomController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       ServletContext context = this.getServletContext();
        ...
        String url = siteMaps.getProperty(MyApplicationConstants.ManageRooms.SEARCH_BOOKED_ROOM_CONTROLLER);
        try {
            ...
            float roomPrice = Float.parseFloat(request.getParameter("txtRoomPrice1"));
            ...
            RoomDTO dto = new RoomDTO(roomId, roomDescription, roomPrice, image, bookingId, bookingDate, checkInDate, checkOutDate, username, status);
