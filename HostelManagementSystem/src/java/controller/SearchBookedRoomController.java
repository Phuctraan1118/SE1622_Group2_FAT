 ...
 * @author Bitano
 */
@WebServlet(name = "SearchBookedRoomController", urlPatterns = {"/SearchBookedRoomController"})
public class SearchBookedRoomController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(SearchBookedRoomController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
