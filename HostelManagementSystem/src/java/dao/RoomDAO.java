...
public class RoomDAO implements Serializable {
    ...
    private static final String SEARCH_BOOKED_BY_USERNAME = "select r.roomId, r.roomDescription , r.roomPrice , r.image ,b.bookingId "
            + ", b.bookingDate , b.checkinDate, b.checkoutDate , b.username, r.status "
            + "from tblRoom r, tblBooking b "
            + "where r.roomId = b.roomId "
            + "and r.status like 'B' and b.username like ?  ";
    ...
    private static final String SEARCH_ALL_BOOKED = "select r.roomId, r.roomDescription , r.roomPrice , r.image ,b.bookingId, b.bookingDate "
            ...
            + "from tblRoom r, tblBooking b "
            + "where r.roomId = b.roomId and r.status like 'B' ";
    ...
    public boolean updateBookedRoom(RoomDTO room)
        ...
        try {
            ...
            if (con != null) {
                ...
                stm.setString(4, room.getBookingDate());
                stm.setString(5, room.getCheckinDate());
                stm.setString(6, room.getCheckoutDate());
                stm.setInt(7, room.getBookingId());
                int value = stm.executeUpdate();
                check = value > 0;
    ...
    public boolean deleteNotBookedRoom(int roomId) throws ClassNotFoundException, SQLException {
        boolean check = false;
        Connection con = null;
        PreparedStatement stm = null;
    ...
    public boolean deleteBookedRoom(RoomDTO room) throws ClassNotFoundException, SQLException {
        boolean check = false;
        Connection con = null;
        PreparedStatement stm = null;
        try {
    ...
    public int getLastIdRoom() throws ClassNotFoundException, SQLException {
        Connection con = null;
        PreparedStatement stm = null;
        ResultSet rs = null;
        int roomId = 0;
