                ...
                <ul class="metismenu" id="menu">
                    <li>
                        <a href="javascript:;" class="has-arrow">
                            ...
                            <div class="menu-title">Hostel Management</div>
                        </a>
                    </li>
                    <li>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="demo-seprater">
                        <h6 class="mb-0 text-uppercase">Cards With Images</h6>
                                ...
                                <div class="row row-cols-1 row-cols-lg-3">
                                    <div class="col">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <h5 class="card-title">${dto.roomId}</h5>
                                                <p class="card-text">${dto.roomDescription}</p>
                                                <td class="btn btn-primary">
                                                    <input type="hidden" name="txtUsername" value="${User.id}" />
                                                    <input type="hidden" name="txtRoomId" value="${dto.roomId}" />
                                                    <input class="btn btn-primary" type="submit" name="btn" value="Booking"/>
                                                </td>
                                            </div>
                                        </div>
                                    </div>
